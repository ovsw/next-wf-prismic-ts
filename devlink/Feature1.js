...
import _styles from "./Feature1.module.css";

export function Feature1({
  as: _Component = _Builtin.Block,
  headingText = "Medium length section heading goes here",
  eyebrowText = "Tagline",
  paragraphText = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare, eros dolor interdum nulla, ut commodo diam libero vitae erat.",
  button1Text = "Button",
          ...
          >
            ...
            >
              ...
              <_Builtin.Block
                ...
                id={_utils.cx(
                  _styles,
                  "w-node-_253ab9a8-84e0-169d-36c4-add92ccb7411-2ccb740a"
                )}
                tag="div"
              >
                <_Builtin.Block
